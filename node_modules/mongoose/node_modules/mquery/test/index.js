...
describe('mquery', function () {
    ...
    describe('or', function () {
        ...
        it('is chainable', function () {
            ...
            assert.deepEqual({ name: 'table', $or: [
                { o: 'k' }
            ] }, m._conditions)
        })
    })
    ...
    describe('nor', function () {
        ...
        it('is chainable', function () {
            ...
            assert.deepEqual({ name: 'table', $nor: [
                { o: 'k' }
            ] }, m._conditions)
        })
    })
    ...
    describe('and', function () {
        ...
        it('is chainable', function () {
            ...
            assert.deepEqual({ name: 'table', $and: [
                { o: 'k' }
            ] }, m._conditions)
        })
    })
        ...
        describe('when called with arguments', function () {
            ...
            describe('of length 1', function () {
                ...
                it('delegates to circle when center exists', function () {
                    ...
                    assert.deepEqual({ $geoWithin: {$center: [
                        [10, 10],
                        3
                    ]}}, m._conditions.loc);
                })
                it('delegates to box when exists', function () {
                    var m = mquery().where('loc').within({ box: [
                        [10, 10],
                        [11, 14]
                    ] });
                    assert.deepEqual({ $geoWithin: {$box: [
                        [10, 10],
                        [11, 14]
                    ]}}, m._conditions.loc);
                })
                it('delegates to polygon when exists', function () {
                    var m = mquery().where('loc').within({ polygon: [
                        [10, 10],
                        [11, 14],
                        [10, 9]
                    ] });
                    assert.deepEqual({ $geoWithin: {$polygon: [
                        [10, 10],
                        [11, 14],
                        [10, 9]
                    ]}}, m._conditions.loc);
                ...
                it('delegates to geometry when exists', function () {
                    var m = mquery().where('loc').within({ type: 'Polygon', coordinates: [
                        [10, 10],
                        [11, 14],
                        [10, 9]
                    ] });
                    assert.deepEqual({ $geoWithin: {$geometry: {type: 'Polygon', coordinates: [
                        [10, 10],
                        [11, 14],
                        [10, 9]
                    ]}}}, m._conditions.loc);
            ...
            describe('of length 2', function () {
                it('delegates to box()', function () {
                    ...
                    assert.deepEqual(m._conditions.loc, { $geoWithin: { $box: [
                        [1, 2],
                        [2, 5]
                    ]}});
                })
            ...
            describe('of length > 2', function () {
                it('delegates to polygon()', function () {
                    ...
                    assert.deepEqual(m._conditions.loc, { $geoWithin: { $polygon: [
                        [1, 2],
                        [2, 5],
                        [2, 4],
                        [1, 3]
    ...
    describe('geoWithin', function () {
        ...
        describe('when called with arguments', function () {
            describe('of length 1', function () {
                it('delegates to circle when center exists', function () {
                    var m = mquery().where('loc').within({ center: [10, 10], radius: 3 });
                    assert.deepEqual({ $within: {$center: [
                        [10, 10],
                        3
                    ]}}, m._conditions.loc);
                })
                ...
                it('delegates to polygon when exists', function () {
                    ...
                    assert.deepEqual({ $within: {$polygon: [
                        [10, 10],
                        [11, 14],
                        [10, 9]
                    ]}}, m._conditions.loc);
                ...
                it('delegates to geometry when exists', function () {
                    ...
                    assert.deepEqual({ $within: {$geometry: {type: 'Polygon', coordinates: [
                        [10, 10],
                        [11, 14],
                        [10, 9]
                    ]}}}, m._conditions.loc);
            ...
            describe('of length 2', function () {
                it('delegates to box()', function () {
                    var m = mquery().where('loc').within([1, 2], [2, 5]);
                    assert.deepEqual(m._conditions.loc, { $within: { $box: [
                        [1, 2],
                        [2, 5]
                    ]}});
                })
            ...
            describe('of length > 2', function () {
                it('delegates to polygon()', function () {
                    var m = mquery().where('loc').within([1, 2], [2, 5], [2, 4], [1, 3]);
                    assert.deepEqual(m._conditions.loc, { $within: { $polygon: [
                        [1, 2],
                        [2, 5],
                        [2, 4],
                        [1, 3]
    ...
    describe('circle', function () {
        describe('with one arg', function () {
            ...
            it('works', function () {
                ...
                assert.deepEqual(m._conditions, { loc: { $geoWithin: {$center: [
                    [0, 0],
                    3
                ] }}});
            })
    ...
    describe('intersects', function () {
        ...
        it('calls geometry if argument quacks like geojson', function (done) {
            var m = mquery();
            var o = { type: 'LineString', coordinates: [
                [0, 1],
                [3, 40]
            ] };
            var ran = false;
        ...
        describe('supports passing GeoJSON, gh-13', function () {
            it('with center', function () {
                var m = mquery().where('loc').near({
                    center: { type: 'Point', coordinates: [1, 1] }, maxDistance: 2
                });
