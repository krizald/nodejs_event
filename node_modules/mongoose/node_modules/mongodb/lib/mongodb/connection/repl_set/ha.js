...
HighAvailabilityProcess.prototype.start = function () {
    ...
    var newServer = new Server(server.host, server.port, {
        auto_reconnect: false, returnIsMasterResults: true, poolSize: 1, socketOptions: {
            ...
            keepAlive: 100
        }, ssl: self.replset.options.ssl, sslValidate: self.replset.options.sslValidate, sslCA: self.replset.options.sslCA, sslCert: self.replset.options.sslCert, sslKey: self.replset.options.sslKey, sslPass: self.replset.options.sslPass
    });
