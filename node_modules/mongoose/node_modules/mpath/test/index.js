    ...
    describe('get', function () {
        ...
        describe('with `special`', function () {
            it('works', function (done) {
                ...
                assert.deepEqual({ _doc: { comments: [
                        {val: 2}
                    ]}}
